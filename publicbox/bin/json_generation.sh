...
echo "" > $PBX_JSON_FILE
echo "{ \"publicbox\" : { \"module\" : { " >> $JSON_FILE
...
#---------------
	echo ", \"version\" : \""$(cat $PUBLICBOX_FOLDER/version )"\""  >> $JSON_FILE
echo " }  } }" >>  $JSON_FILE
