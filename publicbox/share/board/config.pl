...
# System config
use constant ADMIN_PASS => 'foragoodtimecall';	# Admin password. For fucks's sake, change this.
use constant SECRET => 'jkiogvfdejsaioojibvdauio0jokpigre09ujoipvjrw23jr4e9cujewroiqr3fqv089yuhvewiojbwt4h9ewuy90905yigireh0';		# Cryptographic secret. CHANGE THIS to something totally random, and long.
...
# Page look
use constant TITLE => 'PublicBox board';	# Name of this image board
...
use constant TITLEIMG => '/content/img/publicbox-logo-small.png';			# Title image (point to a script file if rotating)
...
use constant MAX_MEGABYTES => 10;				# Maximum size to use for all images in megabytes - set to 0 to disable
